...
?>
	<? if($_SESSION['userID']==""){ //判斷是否有登入並授權，有授權的話userID會是一串數字 ?>
       <h5 align="right"><img src="fb.gif" align="top"><a href="fblogin.php">Facebook登入</a></h5>
        <!-- 連到fblogin去做取得授權跟認證的動作 -->
    <? }else{ ?>
       <h5 align="right">hello,<? echo $_SESSION['name']; ?><img src="https://graph.facebook.com/<?php echo $_SESSION['userID']; ?>/picture"/> <?php echo $_SESSION['name'] ?>您好 | <a href="login.php?logout=true">登出</a></h5>
